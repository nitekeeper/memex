...
2. **Propose a batch list** before touching any file:
   ...
   (On re-entry from session-end step 5: do not display the mode-selection prompt — proceed automatically in the retained approval mode.)
