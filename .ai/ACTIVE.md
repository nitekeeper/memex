...
synced-at-commit: bfe150e4cffd7fef8f5e66264bbecedca6bb3b6b
...
- 4 SKILL.md follow-ups (non-blocking): tighten "intervenes" definition in approve-all; align session-end skip phrasing with on-demand skip phrasing; add mid-batch validation failure rollback policy to error table; add explicit project-root confirmation to step 1 (multi-project workspace safety)
